...
type rolesTable struct {
	...
	DiscordRoleID postgres.ColumnString
...
func newRolesTableImpl(schemaName, tableName, alias string) rolesTable {
	var (
		...
		DiscordRoleIDColumn = postgres.StringColumn("discord_role_id")
		allColumns          = postgres.ColumnList{IDColumn, GuildIDColumn, DiscordRoleIDColumn}
		mutableColumns      = postgres.ColumnList{GuildIDColumn, DiscordRoleIDColumn}
	)
